...
<body>
    ...
    <div style="display:flex; justify-content:center;">
        <section style="padding: 2rem 7rem 2rem 7rem; width:100%">
            <div class="title" style="margin-bottom: 2.5rem;">Verifikasi Email</div>
            <h3>Halo, {{ $user_email }} !</h3>
            <p>Terima kasih telah mendaftarkan email anda ke Akademika. Kami mengirimkan email ini untuk memverifikasi email yang telah anda didaftarkan.</p>
            <p>Silahkan menekan tombol di bawah ini untuk memverifikasi!</p>
            <br><br>
                            ...
                            <tr>
                                <td align="center">
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                            <td>
                                                <a href="{{ $verification_url }}" class="verify-button" target="_blank" rel="noopener">Verifikasi Sekarang!</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
            ...
            <p>Link verifikasi ini akan tidak berlaku 1 jam setelah email ini dikirimkan.</p>
