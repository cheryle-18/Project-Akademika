                    ...
                    <div class=" mt-5 grid grid-cols-12 gap-5">
                        ...
                        <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg col-span-6 flex justify-center">
                            ...
                            <div class="p-6 flex flex-col justify-start">
                                <h5 class="text-gray-900 text-xl font-medium mb-2">Pengembangan Website Front-End Dasar</h5>
                                <p class="text-gray-900 text-base mb-4">
                                    IDR 250.000
                                </p>
                                <p class="text-gray-600 text-base mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi, dolorem?</p>
                                ...
                                <p class="text-gray-600 text-base mb-5">
                                    ...
                                    40 jam
                                    <a href="">
                                        <button type="button" class="inline-block  ml-36 px-6 py-2.5 bg-custom-blue text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Detail</button>
                                    </a>
                                </p>
                            </div>
                        </div>
