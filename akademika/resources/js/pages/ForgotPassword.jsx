    ...
    <div className="h-screen w-full bg-blue-200 overflow-auto">
      ...
      <div className="forgotPassword w-full md:w-1/2 float-right p-10 mt-6">
        ...
        <p className="py-2">
         ...
         <button className="btn btn-block btn-sm h-10 bg-blue-900 text-white hover:border-1 hover:border-blue-900 hover:bg-white hover:text-blue-900 mb-3 capitalize text-base mt-2" onClick={handleClick}>Reset Password</button>
         <Link to="/" className="font-semibold underline mt-3">Return to Login</Link>
      </div>
    </div>
  );
}
